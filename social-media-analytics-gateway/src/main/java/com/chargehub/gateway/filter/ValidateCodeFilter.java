...
import com.chargehub.common.core.properties.CaptchaProperties;
...
{
    private final static String[] VALIDATE_URL = new String[] { "/auth-api/login", "/auth-api/register", "/auth/login", "/auth/register" };
