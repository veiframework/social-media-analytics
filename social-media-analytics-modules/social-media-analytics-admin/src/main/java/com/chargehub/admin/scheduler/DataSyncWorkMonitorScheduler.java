...
public class DataSyncWorkMonitorScheduler {
    ...
    private void fetchWorks(Date now, String accountId, String crawlerLoginState, Map<String, UpdateLoginState> newStorageStateMap, List<String> completeAccountIds) {
