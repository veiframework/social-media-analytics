 ...
 * @Filename：TempRegisterDto
 */
@Data
public class TempRegisterDto {
...
//    private String aliUserId;
    ...
    @ApiModelProperty(value = "支付宝用户openid",notes = " 当前端请求微信小程序登录接口返回code=2002时,后台返回的有aliOpenid字段，前端再次请求密码登录时需要把本字段带上",required = false)
