...
import com.chargehub.biz.admin.service.ISysDictDataService;
...
public class SysDictDataController extends BaseController {
    ...
    @RequiresPermissions(value = {"system:dict:list", "charge:member:preferential:config:list"}, logical = Logical.OR)
    @GetMapping("/list")
     ...
     * 修改保存字典类型
     */
    @RequiresPermissions(value = {"system:dict:edit", "charge:member:preferential:config:edit"}, logical = Logical.OR)
