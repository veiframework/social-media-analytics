...
import com.chargehub.common.core.exception.DemoModeException;
import com.chargehub.common.core.exception.InnerAuthException;
...
import com.chargehub.common.core.exception.auth.NotPermissionException;
import com.chargehub.common.core.exception.auth.NotRoleException;
...
public class GlobalExceptionHandler
{
    ...
    public AjaxResult handleIllegalArgumentException(IllegalArgumentException e, HttpServletRequest request, HttpServletResponse response )
    {
        log.error(e.getMessage(), e);
        configResponse(response);
        return AjaxResult.error(e.getMessage());
    ...
    public AjaxResult handleNotLoginException(NotLoginException e, HttpServletRequest request, HttpServletResponse response)
    {
        String message = e.getMessage();
        return AjaxResult.error(HttpStatus.UNAUTHORIZED, StringUtils.isBlank(message)?"无效token":message);
    }
}
