...
/**
 * @author Zhanghaowei
 * @date 2025/04/12 11:59
 */
@EqualsAndHashCode(callSuper = true)
@Data
@ToString(callSuper = true)
public class AllInPaymentParam extends PaymentParam implements Serializable {
    private static final long serialVersionUID = -7933918375101154389L;
