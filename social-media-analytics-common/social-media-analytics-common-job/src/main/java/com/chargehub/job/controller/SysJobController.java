package com.chargehub.job.controller;
...
import com.chargehub.job.service.ISysJobService;
...
public class SysJobController extends BaseController
{
    ...
    @PostMapping("/remote")
    public AjaxResult add(@RequestBody SysJobDto job) throws SchedulerException, TaskException {
        SysJob sysJob = BeanUtil.copyProperties(job, SysJob.class);
        ...
        sysJob.setCreateBy(SecurityUtils.getNickname());
        return toAjax(jobService.insertRunJob(sysJob));
    }
    ...
    public AjaxResult add(@RequestBody SysJob job) throws SchedulerException, TaskException
    {
        ...
        job.setCreateBy(SecurityUtils.getNickname());
